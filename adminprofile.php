            ...
            <!--OverView-->
               ...
               // error_reporting(~E_ALL); 
                ...
                //echo "SELECT auserid,ausername from areg where auserid='$username'";
                    $result=mysql_query("SELECT auserid,ausername from areg where auserid='$username'");
                   // echo $result;
                      while($row = mysql_fetch_assoc($result))
                      {

                          echo "<p>".$row['auserid']."</p>";
               ...
               // error_reporting(~E_ALL); 
                    //$id = $_GET['id'];
                //echo "SELECT auserid,ausername from areg where auserid='$username'";
                    $result=mysql_query("SELECT auserid,ausername,aimg from areg where auserid='$username'");
                   // echo $result;
                      while($row = mysql_fetch_assoc($result))
                      {
                        ?>
                        <div style="width:250px; height:250px;">
                            <p><strong>Profile Image</strong></p><img src="img/<?php echo $row['aimg'];?>"class="img-rounded" width="250px" height="250px" style="margin-bottom: 100px;"/><hr>
                        </div>
                        <?php 
                    }
                    ?>
               ...
               // error_reporting(~E_ALL); 
                ...
                //echo "SELECT auserid,ausername from areg where auserid='$username'";
                   ...
                   // echo $result;
                      ...
                      {
                        ?>
                        <p>UserID: <?php echo $row['auserid'];?></p><hr>
                        <p>UserName: <?php echo $row['ausername'];?></p><hr>
