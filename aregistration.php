<?php
    ...
    if(empty($ausername) || empty($auserid) || empty($apass)) {
        ...
        if(!isset($errMSG))
        {
        $result = mysql_query("INSERT INTO areg(auserid,ausername,apass,aimg) VALUES('$auserid','$ausername','$apass','$userpic')");
