<?php
    ...
    $fpass = $_POST['userpass'];
    $femail = $_POST['useremail'];
    $fdept = $_POST['userdept'];
    $fphone = $_POST['userphone'];
    //$fimg = $_POST['userpass'];
    ...
    if(empty($fusername) || empty($fuserid) || empty($fpass)) {
        ...
        if(!isset($errMSG))
        {
        $result = mysql_query("INSERT INTO freg(fuserid,fpass,femail,fdept,fphone,fimg,fusername) VALUES('$fuserid','$fpass','$femail','$fdept','$fphone','$userpic','$fusername')");
