<?php
    ...
    $ppass = $_POST['userpass'];
    $pemail = $_POST['useremail'];
    
    $pphone = $_POST['userphone'];
    //$fimg = $_POST['userpass'];
    ...
    if(empty($pusername) || empty($puserid) || empty($ppass)) {
        ...
        if(!isset($errMSG))
        {
        $result = mysql_query("INSERT INTO preg(puserid,pusername,ppass,pemail,pphone,pimg) VALUES('$puserid','$pusername','$ppass','$pemail','$pphone','$userpic')");
            ...
            <div class="col-md-12 ">
                ...
                <div class="input-group-btn">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                      ...
                      <li><a href="aregistration.php">Admin</a></li>
                </div>
                <?php
            if(isset($errMSG)){
                    ?>
            ...
            ?>  
                ...
                <!--User Id-->
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input maxlength="8" type="text" class="form-control"placeholder="UserID" name="userid">
                            </div>
                        </div>
                    <!--userName-->
                    ...
                    <div class="form-group" role="form">
                        ...
                        <div class="col-md-10">
                            <input maxlength="11" type="text" class="form-control"placeholder="PhoneNumber" name="userphone">
                        </div>
                    </div>
                    ...
                    <div class="form-group" role="form">
                        ...
                        <div class="form-group">
                            <div class="col-md-10">
                            <label class="control-label">ProfileImages</label>
